...
class AhviNotificationService {
  ...
  static const String _unreadKey =
      'ahvi_medi_notification_unread_count';
  static const String _latestKey =
      'ahvi_medi_notification_latest';
  ...
  Future<void> _storeForegroundMediReminder(
    ...
    await _localNotifications.initialize(
      ...
      onDidReceiveNotificationResponse: (response) {
        ...
        try {
          ...
          debugPrint(
            'AHVI notification tap payload ignored: $e',
          );
        }
      },
    );
  ...
  Future<void> _showForegroundMediNotification(
    ...
    if (!_localNotificationsReady || !Platform.isAndroid) {
      return;
    }
  ...
  Future<void> _handleMediReminder(
    RemoteMessage message,
    String source,
  ) async {
    ...
    if (source == 'foreground') {
      debugPrint(
        'AHVI_MED_NOTIFICATION_FOREGROUND data=$data',
      );
    ...
    debugPrint(
      'AHVI_MED_NOTIFICATION_OPENED source=$source data=$data',
    );
    _onMediReminder?.call(data);
  }
